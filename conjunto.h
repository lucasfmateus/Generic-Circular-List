...
void adiciona(Conjunto* C, void* c, void (*imprime)(void*));
void retirar(Conjunto* C,  void* c, bool (*compara)(void*, void*));
bool pertence(const Conjunto* C, void* c, bool (*compara)(void*, void*));
